...
# Ask Doubt on telegram @sonu77733
...
async def send_start(client: Client, message: Message):
    ...
    buttons = [[
        ...
        InlineKeyboardButton('🔍 sᴜᴘᴘᴏʀᴛ ɢʀᴏᴜᴘ', url='https://t.me/+M9l_J912N2cwMTFl'),
        InlineKeyboardButton('🤖 ᴜᴘᴅᴀᴛᴇ ᴄʜᴀɴɴᴇʟ', url='https://t.me/+M9l_J912N2cwMTFl')
    ]]
